...
public class MeetingDetailsPresenter {
    ...
    public void getMeetingDetailsService(String url) {
        ...
        System.out.println("getMeetingDetailsService url "+url);
        StringRequest req = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        System.out.println("getMeetingDetailsService "+str_response);
                        ...
                        try {
                            ...
                            if(status.equals("success")){
                                ...
                                MeetingsData.get_current_mtnOtpStatus = jsonObj.getString("mtnOtpStatus");
    ...
    public void otpVerificationService(String url,
                                       final String userId,
                                       final String mtnId,
                                       final String mtnOtp) {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            String message = jsonObj.getString("message");
                            if(status.equals("failed")){
                                view.errorOTPVerificationInfo(message);
                            }else{
                                view.successOTPVerificationInfo(message);
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
    ...
    public void otpResendService(String url,
                                       final String userId,
                                       final String mtnId) {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            String message = jsonObj.getString("message");
                            if(status.equals("failed")){
                                view.errorOTPResendInfo(message);
                            }else{
                                view.successOTPResendInfo(message);
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
