...
public class MeetingDetailsActivity extends AppCompatActivity implements MeetingDetailsActivityView {
    ...
    private Button btn_otp_verification,btn_otp_resend;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tv_otp_verification=(TextView)findViewById(R.id.activity_meeting_tv_otp_verification);
        ...
        btn_otp_verification=(Button)findViewById(R.id.activity_meeting_btn_otp_verification);
        btn_otp_resend=(Button)findViewById(R.id.activity_meeting_btn_otp_resend);
        ...
        btn_otp_verification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(isVisited) {
                    ...
                    Toast.makeText(MeetingDetailsActivity.this,"Please first update the visit for this meeting", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    public void successInfo(String msg){
        ...
        //"mtnOtpStatus":"verifiedNot" "mtnVisited":"no"
        if(MeetingsData.get_current_mtnVisited.equalsIgnoreCase("no")){
            isVisited=false;
        }else {
            isVisited=true;
        }

        if(MeetingsData.get_current_mtnOtpStatus.equalsIgnoreCase("verifiedNot")){
            tv_otp_verification.setVisibility(View.GONE);
            btn_otp_verification.setVisibility(View.VISIBLE);
            btn_otp_resend.setVisibility(View.VISIBLE);
        }else {
            tv_otp_verification.setVisibility(View.VISIBLE);
            btn_otp_verification.setVisibility(View.GONE);
            btn_otp_resend.setVisibility(View.GONE);
        }
...
/*
    ...
    public void openOTPVerificationDialog() {
        ...
        final EditText et_message = (EditText) dialog.findViewById(R.id.dialog_meeting_otp_et_message);
        ImageButton ib_cancel = (ImageButton) dialog.findViewById(R.id.dialog_meeting_otp_ib_cancel);
        Button btn_submit = (Button) dialog.findViewById(R.id.dialog_meeting_otp_btn_submit);

        btn_submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String meeting_otp_message = et_message.getText().toString();
                if(meeting_otp_message.equalsIgnoreCase("")){
                    Toast.makeText(MeetingDetailsActivity.this,"otp can not be blank", Toast.LENGTH_LONG).show();
                }else {
                    submitOTP(meeting_otp_message);
                }
            }
        });
    ...
    public void submitOTP(final String mtnOtp) {
        ...
        if(isNetworkAvailable()){
            ...
            presenter.otpVerificationService(UrlUtil.OTP_VERIFICATION_URL,
                    userId,
                    mtnId,
                    mtnOtp);
    ...
    public void errorOTPVerificationInfo(String msg){
        progress.dismiss();
        dialog.dismiss();
        MDToast.makeText(this, msg, MDToast.LENGTH_LONG, MDToast.TYPE_ERROR);
    }

    public void successOTPVerificationInfo(String msg){
        progress.dismiss();
        dialog.dismiss();
        tv_otp_verification.setVisibility(View.VISIBLE);
        btn_otp_verification.setVisibility(View.GONE);
    ...
    public void otpResend(){
        ...
        if(isNetworkAvailable()){
            ...
            presenter.otpResendService(UrlUtil.OTP_RESEND_URL,
                    userId,
                    mtnId);
    ...
    public void errorOTPResendInfo(String msg){
        progress.dismiss();
        MDToast.makeText(this, msg, MDToast.LENGTH_LONG, MDToast.TYPE_ERROR);
    }
    public void successOTPResendInfo(String msg){
        progress.dismiss();
        MDToast.makeText(this, msg, MDToast.LENGTH_LONG, MDToast.TYPE_SUCCESS);
    }
