...
public interface MeetingDetailsActivityView {
    ...
    void errorOTPVerificationInfo(String msg);
    void successOTPVerificationInfo(String msg);


    void errorOTPResendInfo(String msg);
    void successOTPResendInfo(String msg);
}
