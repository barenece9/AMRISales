...
public class UrlUtil {
    ...
    public static String MAIN_URL = "http://app.lnsel.in/amrisales/";
    ...
    //for otp resend
    public static String OTP_RESEND_URL = BASE_URL+"update_meeting_visited_resend_otp";

    //for otp verification
    public static String OTP_VERIFICATION_URL = BASE_URL+"update_meeting_visited_otp_validate";
}
